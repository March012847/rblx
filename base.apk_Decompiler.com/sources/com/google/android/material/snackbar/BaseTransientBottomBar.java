...
public abstract class BaseTransientBottomBar {
    ...
    protected BaseTransientBottomBar(Context context2, ViewGroup viewGroup, View view2, ContentViewCallback contentViewCallback2) {
        if (viewGroup == null) {
            ...
            this.animationSlideDuration = MotionUtils.resolveThemeDuration(context2, i, 250);
            this.animationFadeInDuration = MotionUtils.resolveThemeDuration(context2, i, 150);
            ...
            this.animationFadeInterpolator = MotionUtils.resolveThemeInterpolator(context2, i2, DEFAULT_ANIMATION_FADE_INTERPOLATOR);
            this.animationScaleInterpolator = MotionUtils.resolveThemeInterpolator(context2, i2, DEFAULT_ANIMATION_SCALE_INTERPOLATOR);
            this.animationSlideInterpolator = MotionUtils.resolveThemeInterpolator(context2, i2, DEFAULT_ANIMATION_SLIDE_INTERPOLATOR);
        } else {
    ...
    public void updateMargins() {
        ...
        if (!(layoutParams instanceof ViewGroup.MarginLayoutParams)) {
            ...
            if ((z || this.appliedBottomMarginGestureInset != this.extraBottomMarginGestureInset) && shouldUpdateGestureInset()) {
    ...
    public BaseTransientBottomBar setAnchorView(View view2) {
        Anchor anchor2;
    ...
    public void onViewShown() {
        ...
        if (list != null && list.size() - 1 >= 0) {
            ToolbarActionBar$$ExternalSyntheticThrowCCEIfNotNull0.m(this.callbacks.get(size));
            throw null;
        }
    }
    ...
    class Anchor implements View.OnAttachStateChangeListener, ViewTreeObserver.OnGlobalLayoutListener {
