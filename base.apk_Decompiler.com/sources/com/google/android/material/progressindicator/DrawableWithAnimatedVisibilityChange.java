    ...
    public float getPhaseFraction() {
        ...
        if (this.baseSpec.hasWavyEffect(isDeterminateDrawable()) && this.baseSpec.waveSpeed != 0) {
            ...
            if (systemAnimatorDurationScale > 0.0f) {
                ...
                int i2 = (int) (((((float) i) * 1000.0f) / ((float) this.baseSpec.waveSpeed)) * systemAnimatorDurationScale);
                float uptimeMillis = ((float) (SystemClock.uptimeMillis() % ((long) i2))) / ((float) i2);
