...
public final class KeylineState {
    ...
    private KeylineState(float f, List list, int i, int i2, int i3) {
        this.itemSize = f;
    ...
    public Keyline getLastKeyline() {
        ...
        return (Keyline) list.get(list.size() - 1);
    }
    ...
    static KeylineState lerp(KeylineState keylineState, KeylineState keylineState2, float f) {
        if (keylineState.getItemSize() == keylineState2.getItemSize()) {
            List keylines2 = keylineState.getKeylines();
            List keylines3 = keylineState2.getKeylines();
            if (keylines2.size() == keylines3.size()) {
                ArrayList arrayList = new ArrayList();
                for (int i = 0; i < keylineState.getKeylines().size(); i++) {
                    arrayList.add(Keyline.lerp((Keyline) keylines2.get(i), (Keyline) keylines3.get(i), f));
                }
    ...
    static KeylineState reverse(KeylineState keylineState, int i) {
        ...
        float f = (((float) i) - keylineState.getLastKeyline().locOffset) - (keylineState.getLastKeyline().maskedItemSize / 2.0f);
    ...
    public final class Builder {
        ...
        public Builder addKeyline(float f, float f2, float f3, boolean z, boolean z2) {
            ...
            if (f7 > ((float) i)) {
                f4 = Math.abs(f7 - Math.max(f7 - f3, (float) i));
            } else {
                f4 = 0.0f;
                if (f6 < 0.0f) {
