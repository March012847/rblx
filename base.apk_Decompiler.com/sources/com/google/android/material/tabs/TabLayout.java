...
public class TabLayout extends HorizontalScrollView {
    ...
    private void applyModeAndGravity() {
        ...
        this.slidingTabIndicator.setPaddingRelative(i, 0, 0, 0);
        int i3 = this.mode;
        if (i3 == 0) {
    ...
    public final class TabView extends LinearLayout {
        ...
        private void tryAttachBadgeToAnchor(View view) {
            if (hasBadgeDrawable() && view != null) {
                ...
                BadgeUtils.attachBadgeDrawable((BadgeDrawable) null, view, (FrameLayout) null);
        ...
        private void tryRemoveBadgeFromAnchor() {
            if (hasBadgeDrawable()) {
                ...
                View view = this.badgeAnchorView;
                if (view != null) {
                    BadgeUtils.detachBadgeDrawable((BadgeDrawable) null, view);
        ...
        public void tryUpdateBadgeDrawableBounds(View view) {
            if (hasBadgeDrawable() && view == this.badgeAnchorView) {
                BadgeUtils.setBadgeDrawableBounds((BadgeDrawable) null, view, (FrameLayout) null);
            }
        }
    ...
    class SlidingTabIndicator extends LinearLayout {
        ...
        public void tweenIndicatorPosition(View view, View view2, float f) {
            if (view == null || view.getWidth() <= 0) {
                ...
                TabIndicatorInterpolator access$1500 = TabLayout.this.tabIndicatorInterpolator;
                TabLayout tabLayout = TabLayout.this;
                access$1500.updateIndicatorForOffset(tabLayout, view, view2, f, tabLayout.tabSelectedIndicator);
            }
